...
export class Issuer {
  constructor(public NFTIssuerPK: string) {}
}
...
export class UpdateStellarTXN {
  constructor(public ImageBase64: string, public NFTTxnHash: string) {}
}
...
export class UpdateSVG {
  constructor(public blockchain: string = 'NA', public Id: string) {}
}

export class Thumbnail {
  constructor(public Id: string, public Thumbnail: string) {}
}
