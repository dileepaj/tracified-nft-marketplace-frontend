...
export class Mint2Component implements OnInit {
  ...
  ngOnChanges(changes: any) {
    const mintVals = changes.mint1Data.currentValue;
    this.mint.NFTName = mintVals.NFTName;
    this.mint.Description = mintVals.Description;
    this.mint.Collection = mintVals.Collection;
    this.mint.NftContentURL = mintVals.NftContentURL;
    this.mint.Imagebase64 = mintVals.svg.Base64ImageSVG;
  }
}
