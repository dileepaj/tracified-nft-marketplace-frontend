...
export class ApiServicesService {
  ...
  addSVG(st: SVG): Observable<SVG> {
    //request to add collection into the nft backend DB
    const svgToAdd = this.http.post<SVG>(this.baseUrlSaveSvg, st, {
      headers: this.headers,
    });
    return svgToAdd;
  }
  addSubscription(st: Subscription): Observable<Subscription> {
    //request to add collection into the nft backend DB
    const svgToAdd = this.http.post<Subscription>(this.baseUrlSubscribe, st, {
      headers: this.headers,
    });
    return svgToAdd;
  }
  checkifSubscribed(email: string): Observable<Subscription> {
    return this.http.get<Subscription>(
      `${this.baseURLSubscribeCheck}/${email}`
    );
  }
  updateSVGBlockchain(st: UpdateSVG): Observable<UpdateSVG> {
    this.UpdatesvgResponseObservable = this.http.put<UpdateSVG>(
      this.baseUrlUpdateSVGBC,
      st,
      { headers: this.headers }
    );
  ...
  addTXN(st: TXN): Observable<TXN> {
    //request to add collection into the nft backend DB
    return this.http.post<TXN>(this.baseUrlSaveTxn, st, {
      headers: this.headers,
    });
  }

  addToWatchList(st: WatchList): Observable<WatchList> {
    return this.http.post<WatchList>(this.baseUrlSaveWatchlist, st, {
      headers: this.headers,
    });
  }

  addToFavourites(st: Favourites): Observable<Favourites> {
    return this.http.post<Favourites>(this.baseUrlSaveFavs, st, {
      headers: this.headers,
    });
  }
  ...
  getFavouritebyBlockchainandUserPK(
    ...
    return this.http.get<NFT>(
      `${this.getfavouritebyUserPK}/${blockchain}/${userPK}/${nftidentifier}`
    );
  }

  removeuserfromFavourite(favouriteID: string): Observable<NFT> {
    return this.http.delete<NFT>(
      `${this.removeUserfromFavourite}/${favouriteID}`
    );
  }
  ...
  getWatchListByBlockchain(Blockchain: string): Observable<WatchList[]> {
    ...
    return this.http.get<WatchList[]>(
      `${this.baseUrlGetWatchlist}/${Blockchain}`
    );
  }
  ...
  endorse(st: Endorse): Observable<Endorse> {
    //request to add collection into the nft backend DB
    return this.http.post<Endorse>(this.baseUrlEndorse, st, {
      headers: this.headers,
    });
  }
  ...
  updateEndorsement(st: UpdateEndorse): Observable<UpdateEndorse> {
    return this.http.put<UpdateEndorse>(this.baseUrlUpdateEndorse, st, {
      headers: this.headers,
    });
  }

  updateEndorsementStatus(st: UpdateStatus): Observable<UpdateStatus> {
    return this.http.put<UpdateStatus>(this.baseUrlEndorsement, st, {
      headers: this.headers,
    });
  }
  ...
  registerPartner(st: Partners): Observable<Partners> {
    //request to add collection into the nft backend DB
    return this.http.post<Partners>(this.baseUrlPartner, st, {
      headers: this.headers,
    });
  }
  ...
  updatePartner(st: UpdatePartners): Observable<UpdatePartners> {
    return this.http.put<UpdatePartners>(this.baseUrlPartner, st, {
      headers: this.headers,
    });
  }
  ...
  getFavouritesByBlockchainAndNFTIdentifier(
    ...
    return this.http.get<NFT[]>(
      `${this.baseUrlGetFavs}/${blockchain}/${nftidentifier}`
    );
  }
  ...
  findFavouritesByBlockchainAndNFTIdentifier(
    ...
    return this.http.get<NFT[]>(
      `${this.baseUrlFindFavs}/${blockchain}/${nftidentifier}`
    );
  }
  ...
  getWatchlistByBlockchainAndNFTIdentifier(
    ...
    return this.http.get<NFT[]>(
      `${this.baseUrlGetWatchlist}/${blockchain}/${nftidentifier}`
    );
  }
  ...
  getWatchlistbyBlockchainandUserPK(
    ...
    return this.http.get<NFT>(
      `${this.getwatchlistbyUserPK}/${blockchain}/${userPK}/${nftidentifier}`
    );
  }
  removeuserfromWatchList(watchlistID: string): Observable<NFT> {
    return this.http.delete<NFT>(
      `${this.removeUserfromWatchList}/${watchlistID}`
    );
  }
  findWatchlistByBlockchainAndNFTIdentifier(
    ...
    return this.http.get<NFT[]>(
      `${this.baseUrlGetWatched}/${blockchain}/${nftidentifier}`
    );
  }

  getUSD(currency: string) {
    return this.http.get(
      `${'https://api.cryptonator.com/api/full'}/${currency}`
    );
  }

  addReviews(st: Reviews): Observable<Reviews> {
    return this.http.post<Reviews>(this.baseUrlSaveReview, st, {
      headers: this.headers,
    });
  }
  ...
  getReviewsByFilter(
    ...
    return this.http.get<Reviews[]>(
      `${this.baseUrlFilterReview}/${filter}/${id}/${this.pageSize}/${page}`
    );
  }
  ...
  addStory(st: NFTStory): Observable<NFTStory> {
    return this.http.post<NFTStory>(this.baseUrlSaveStory, st, {
      headers: this.headers,
    });
  }
