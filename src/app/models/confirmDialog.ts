...
export const SnackBarText = {
  ...
  CONNECT_TO_TESTNET: 'Please connect to a test network.',
  CONNECT_TO_STELLAR_MAIN_NET: 'Please connect to Stellar main net.',
  CONNECT_TO_ETHEREUM_MAIN_NET: 'Please connect to Ethereum main net.',
  CONNECT_TO_POLYGON_MAIN_NET: 'Please connect to Polygon main net.'
}
